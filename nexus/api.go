...
func (e *OperationError) Error() string {
	...
	if len(e.Message) > 0 {
		...
		// Only apend the cause if message is unset for compatibility with older SDKs which did not have a
		// Message attribute.
...
const (
	// The server cannot or will not process the request due to an apparent client error. Clients should not
